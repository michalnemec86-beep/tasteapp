...
function HopLogo() {
  return (
    ...
    >
      ...
      <path d="M14.4 7.1C17.2 7.6 19 8.9 19.7 11.2C17.5 11.3 15.8 11.9 14.5 13.1C13.9 11.2 13.7 9.2 14.4 7.1Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
